...
> **Status:** v1.1 operational — design written 2026-05-22, implemented + refined 2026-05-22 in same session. Documents the as-built research-security infrastructure. Hook scripts live at `.claude/hooks/`, helpers at `.claude/hooks/lib/`, state at `.tgf/state/`, git pre-commit at `.claude/git-hooks/`, smoke tests at `tests/research-security-smoke-test.sh`. Cross-references: `CLAUDE.md`, `docs/ARCHITECTURE.md`, `docs/WORKFLOW.md`, `docs/DECISIONS.md`, `docs/research-security-implementation-plan.md` (build plan), `docs/framework-hardening-plan.md` (workstream sequencing).
